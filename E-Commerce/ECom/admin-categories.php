...
if(isset($_GET['type']) && $_GET['type']!=''){
    ...
    if($type=='status'){
        ...
        $update_status_sql="update `montemayor car dealership`.categories  set status='$status' where cat_ID='$id'";
        mysqli_query($con,$update_status_sql);
    }

    if($type=='delete'){
        $id=get_safe_value($con,$_GET['id']);
        $delete_sql="delete from `montemayor car dealership`.categories where cat_ID='$id'";
        mysqli_query($con,$delete_sql);
    }
}

$sql="select * from `montemayor car dealership`.categories";
                                    ...
                                    while($row=mysqli_fetch_assoc($res)){?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                echo "<span class='badge badge-edit'><a href='manage-categories.php?id=".$row['cat_ID']."'>Edit</a></span>&nbsp;";
