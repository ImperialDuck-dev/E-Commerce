...
if(isset($_GET['type']) && $_GET['type']!=''){
    ...
    if($type=='status'){
        ...
        $update_status_sql="update `montemayor car dealership`.cars_secondary set status='$status' where item_id='$id'";
        mysqli_query($con,$update_status_sql);
    }

    if($type=='delete'){
        $id=get_safe_value($con,$_GET['id']);
        $delete_sql="delete from `montemayor car dealership`.cars_secondary where item_id='$id'";
        mysqli_query($con,$delete_sql);
    }
}

$sql="select * from `montemayor car dealership`.cars_secondary";
                                    ...
                                    while($row=mysqli_fetch_assoc($res)){?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                echo "<span class='badge badge-edit'><a href='manage-offer.php?id=".$row['item_id']."'>Edit</a></span>&nbsp;";
